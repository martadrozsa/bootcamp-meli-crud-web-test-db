...
func (p *ProductRepositoryMock) UpdatePrice(ctx context.Context, id int64, price float64) error {
	args := p.Called(ctx, id)
...
func (p *ProductRepositoryMock) Delete(ctx context.Context, id int64) error {
	args := p.Called(ctx, id)
